...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? **It is saying that "left_join" is being used with the "County" columb to combine the two data frames.**
