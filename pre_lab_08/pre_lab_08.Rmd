...
**The mutation is creating a new column called UNAF_DIFF which subtracts UNAF_2022 from UNAF_2024. The arrange is putting the md_voters dataset in descending order based off the new column made. THe select feature then sorts the dataset by two columns: county and UNAF_DIFF. The head(10) shows the top ten rows for the sorted data while maryland_top_counties showed the counties with the largest difference in UNAF_DIFF.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see an empty, grey canvas. There is no such chart showing. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a full bar chart now. Count is on the y-axis and county is on the x-axis. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It is now in ascending order, as in the lowest values are on the left of the chart. The values increase as it moves from left to right, with the largest values on the right.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The coordinates have now been flipped. It went from a vertival bar chart to a horizontal bar chart. The largest values are now at the top while the smaller values are at the bottom.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There is less color on the chart now. There used to be a grey background for the chart. It is now white. **
...
**Task** Run the following code. **Code was run. Package should have been installed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **The theme has been changed to match the theme of charts at The Economist. There is a blueish backrgound while the bars are a dark grey. There is also a larger font for the text. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There is now a title for the chart: "Counties with Biggest Jumps in Unaffiliated Votes." The source of the data is also included at the bottom of the chart. The name for the y-axis has also been changed. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It is the total number of contributions for each day from April 1, 2022 to June 30 2022.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **There is a line chart displayed. Total_contributions is on the y-axis while date is on the x-axis. The line is black while there is a light grey background to the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Dates have been added to the bottom of the chart in intervals of one week. Before, the chart just displayed the month. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **The text of the dates now have an angle to them. Before, the dates where just written straight. **
