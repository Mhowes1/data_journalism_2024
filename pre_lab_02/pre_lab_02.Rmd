...
**It is arranging the data in alphabetical order by county name with the percentage of election day voting. **
...
**It arranged the results by highest percentage of election day voting to lowest percentage.**
...
**I believe this is a more interesting answer because it shows a trend in the parties that vote early and mail in versus election day voting. It took for the end of the second page to have a republican which had low amounts of election day reporting. **
...
**str_replace(): It replaces the first occurrence of a pattern in a string. str_detect(): It detects if there is a pattern in a spring. **
...
**The mutate() function adds a new column, called amount_category, and it categorizes the amount values into different ranges, such as between $100 and $499. **
...
**It preserved the original dataset and lets us work with a filtered version of the data. **
...
**It has been converted from character format to date format (Year, Month, Date) :**
...
**The new month column is showing the first day of each month provided. Data is showing the total amount for the month shown, from the beginning of the month using floor_date. **
