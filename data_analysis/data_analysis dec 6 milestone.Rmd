...
maryland_demographic_data <- get_acs(
  geography = "zcta",  # ZCTA (ZIP Code Tabulation Area)
  variables = c(
    "B01003_001" = "total_population",  # Total population
    "B01002_001" = "median_age",       # Median age
    "B19013_001" = "median_income",     # Median household income
    "B02001_002" = "white_alone",      # White alone
    "B02001_003" = "black_alone",      # Black alone
    "B02001_004" = "native_american",  # Native American
    "B02001_005" = "asian_alone",      # Asian alone
    "B02001_006" = "hawaiian_pacific", # Hawaiian/Pacific Islander
    "B02001_007" = "other_race",       # Other race
    "B02001_008" = "two_or_more_races" # Two or more races
  ),
  year = 2020,              # ACS 5-year estimates from 2020
  survey = "acs5",          # Use ACS 5-year estimates
  state = "24",             # Maryland's FIPS code
  zcta = TRUE,              # Get data by ZIP code (ZCTA)
...
#all_md_contrib <- final_data_states  |>
 # filter(state == "MD") 

#md_zips <- all_md_contrib |> 
...
# Step 1: limit data set to top ten recipients 
